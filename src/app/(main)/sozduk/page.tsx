...
function SozdukContent() {
  ...
  }, [query, activeCategory, sortOrder, entries])

  return (
    <>
      <div className="flex gap-2 mb-4">
        <div className="flex-1">
          <SearchBar placeholder="Сөз издөө / Поиск слова..." onSearch={setQuery} />
        </div>
              ...
              <CardContent className="p-5">
                <div className="flex flex-wrap items-start gap-x-4 gap-y-1">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-foreground/80" style={{ fontFamily: 'var(--font-nunito)' }}>
                      {entry.word_ru}
                    </span>
                    {entry.category && (
